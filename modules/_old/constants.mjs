 ...
 */
export const GROUP = {
  attributes:      { id: "attributes", name: "TokenActionHud.Groups.Names.attributes", type: "system" },
  combat:          { id: "combat", name: "TokenActionHud.Groups.Names.combat", type: "system" },
  combatUtilities: { id: "combatUtilities", name: "TokenActionHud.Groups.Names.combat", type: "system" },
  other:           { id: "other", name: "TokenActionHud.Groups.Names.other", type: "system" },
  system:          { id: "system", name: "TokenActionHud.Groups.Names..system", type: "system" },
  favorites:       { id: "favorites", name: "TokenActionHud.Groups.Names.favorites", type: "system"},
  weapons:         { id: "weapons", name: "TokenActionHud.Groups.Names.weapons", type: "system"},
