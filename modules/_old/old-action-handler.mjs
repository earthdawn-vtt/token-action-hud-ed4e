...
export let OldActionHandler = null;

Hooks.once( "tokenActionHudCoreApiReady", async ( coreModule ) => {
  OldActionHandler = class ActionHandler extends coreModule.api.ActionHandler {
